...
const WatchAndLearn: React.FC = () => {
    return (
        <div className='w-full flex flex-col items-center bg-[#F5F2F0] p-20 gap-10'>
            <div className='max-w-[600px] flex flex flex-col items-center gap-8'>
            ...
            <div className='flex gap-10'>
                {
                    MediaLinkDetials.map((media)=>(
                        <MediaLinkCard img={media.img} title={media.title} content={media.content}/>
                    ))
                }
            </div>
        </div>
