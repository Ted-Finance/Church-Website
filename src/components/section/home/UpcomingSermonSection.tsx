...
const UpcomingSermonSection: React.FC = () => {
    return (
        <div className='flex flex-col gap-8 items-center my-10 w-full md:px-20 relative'>
            ...
            <div className='flex flex-col md:flex-row w-full h-fit md:h-[512px]'>
            ...
            <div className='z-20 self-end flex items-center gap-5 absolute m-5 md:m-0 md:static bottom-0 left-0'>
                <Link to={"#"} className='text-right text-[24px] text-primary-500 md:text-secondary '>View all Sermons</Link>
                <FaArrowRightLong className='text-[24px] text-primary-500 md:text-secondary'/>
            </div>
