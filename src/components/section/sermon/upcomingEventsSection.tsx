...
const UpcomingSermonSection: React.FC = () => {
    return (
        <div className='flex flex-col gap-8 items-center my-24 w-full md:px-20 relative'>
            ...
            <div className='flex flex-col-reverse md:flex-row w-full h-fit md:h-[512px]'>
            ...
            <div className='self-end flex items-center gap-5 absolute bottom-0 right-0 m-5 md:static'>
                <Link to={"#"} className='text-right text-[24px]'>View all Sermons</Link>
                <FaArrowRightLong className='text-secondary text-[24px]' />
            </div>
