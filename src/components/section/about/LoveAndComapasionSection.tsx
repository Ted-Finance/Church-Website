    ...
    return (
        <div className='mt-20 flex flex-col items-center px-10'>
            ...
            <motion.div
                ...
                whileInView="show"
                viewport={{ once: true, amount: 0.2 }}
                className='w-full md:w-auto flex gap-3 md:gap-8 mt-10 items-center '>
                <motion.div
                    variants={{
                        hidden: { opacity: 0, y: 20 },
                        show: { opacity: 1, y: 0, transition: { duration: 0.5 } },
                    }}
                    className='w-[293px] h-[160px]  md:h-[384px] rounded-[40px] md:rounded-[60px] overflow-hidden border relative'>
                ...
                <motion.div
                    ...
                    className='w-[390px] h-[250px] md:h-[512px] rounded-[40px] md:rounded-[60px] overflow-hidden relative'>
                ...
                <motion.div
                    ...
                    className='w-[293px] h-[160px] md:h-[384px] rounded-[40px] md:rounded-[60px] overflow-hidden relative'>
            ...
            <motion.div
                ...
                whileInView="show"
                viewport={{ once: true, amount: 0.2 }}
                className='flex flex-col md:flex-row md:max-w-[900px] items-center gap-2 mt-20 mb-20'>
                <motion.div
                    variants={{
                        hidden: { opacity: 0, y: 20 },
                        show: { opacity: 1, y: 0, transition: { duration: 0.5 } },
                    }}
                    className=' h-[367px] flex flex-col gap-5 px-0 md:px-8 py-8 relative group'>
