...
const BenefitSection: React.FC = () => {
    return (
        <div className='w-full flex flex-col items-center md:p-20 gap-10'>
            <div className='max-w-[600px] flex flex-col items-center gap-3 md:gap-8 px-5 md:px-0'>
            ...
            <div className='flex flex-col gap-12 w-full'>
                {/* 1 */}
                <div className='v-full flex flex-col md:flex-row gap-10 justify-between md:px-20 items-center'>
                ...
                {/* 2 */}
                <div className='flex flex-col-reverse md:flex-row gap-10 justify-between md:px-20 items-center'>
                    <div className='w-full md:w-[500px] h-[320px] rounded-[50px] overflow-hidden'>
                ...
                {/* 3 */}
                <div className='flex flex-col md:flex-row gap-10 justify-between md:px-20 items-center'>
                    <div className='w-full md:w-[50%] flex flex-col gap-3 px-8 md:px-0'>
