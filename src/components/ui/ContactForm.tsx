...
const ContactForm: React.FC = () => {
  return (
    <div>
      <form action="" className='w-[624px] flex flex-col gap-[10px]'>
        ...
        <textarea className='focus:outline-none focus:ring-primary-300 max-w-[624px] p-[20px] rounded-[4px]' name="message" id="message" cols={30} rows={5}></textarea>
